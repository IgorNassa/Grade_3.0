...
public class AppTheme {
    ...
    /** Painel com borda arredondada e fundo card */
    ...
    /**
     * Renderer para colunas de Status.
     * Substitui o texto "Ativo" por uma bolinha verde centralizada.
     */
    public static TableCellRenderer statusRenderer() {
        return new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
                ...
                // Criamos um painel para desenhar a bolinha
                JPanel p = new JPanel(new BorderLayout()) {
                    ...
                    protected void paintComponent(Graphics g) {
                        ...
                        // Brilho sutil (glow)
                        if ("Ativo".equalsIgnoreCase(val)) {
                            g2.setColor(new Color(SUCCESS.getRed(), SUCCESS.getGreen(), SUCCESS.getBlue(), 60));
                ...
                // Sincroniza cores de seleção/fundo com a tabela
                p.setBackground(getBackground());
                p.setToolTipText(String.valueOf(value));
                return p;
            }
        };
    }
