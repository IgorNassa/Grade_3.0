...
import br.sistema.model.service.impl.AulaServiceTxDecorator;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            // Instanciações usando as classes concretas para respeitar os construtores dos Services
            ...
            // Core do Backtracking sem contexto de transação
            AulaService aulaServiceCore = new AulaServiceImpl(aulaRepo, professorRepo);

            // O Decorator Transacional assume a responsabilidade pelas transações no banco
